...
1. Based on the pre-trained large model, re-fine-tune. The best.ckpt file of the fine-tuned large model can be obtained from:
Link: https://pan.quark.cn/s/126a9ceaf115

2. If you want to fine-tune the large model, please first place the pre-trained large model and data in the following path: .\moftransformer\database\. 
File acquisition address:
Model file:
Link: https://pan.quark.cn/s/126a9ceaf115
qmof:
Link: https://pan.quark.cn/s/20235baa0d3a
coremof:
Link: http s://pan.quark.cn/s/1fd635566f7c

3. If you want to use the fine-tuned large model for testing and prediction, please place the fine-tuned model best.ckpt in the following path: .\moftransformer\logs\pretrained_mof_seed0_from_pmtransformer\version_0\checkpoints\

4. The prediction results are placed in the following path: .\moftransformer\logs\pretrained_mof_seed0_from_pmtransformer\version_0\

Note: If an error is reported during the prediction process, indicating that the finetuned_bandgap.ckpt file is not found, just rename the best.ckpt file to finetuned_bandgap.ckpt and place it in the following path: .\moftransformer\examples\
